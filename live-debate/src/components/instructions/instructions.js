	...
	if (this.props.mode == 1) {
            return (
              ...
              return (
		        ...
		        <li> After this you will be shown some comments posted by users when the debate was aired. Please <b>read through the comments</b> before proceeding to the next step </li>
